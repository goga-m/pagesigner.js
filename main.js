...
const snapshotID = 'snap-03bae56722ceec3f0'
const imageID = 'ami-1f447c65'
let oracles_intact = false //must be explicitely set to true
...
function init() {
  ...
  let oracle_hash = ba2hex(sha256(JSON.stringify(chosen_notary)))
  let was_oracle_verified = false
...
function writeFile(dirName, fileName, data) {
  return new Promise(function(resolve, reject) {
    ...
    console.log('write in storage', obj)
